...
**AI Agent** 是“由 AI 驱动、能在规则内替人完成事情的系统”。你给它目标，它会读取当前状态、选择下一步，需要时使用工具，再根据结果继续、修正、停止，或把控制权交还给人。只回答一次的聊天机器人，或每一步都预先固定好的脚本，不一定是 Agent。这个 repo 不要求你一开始就懂所有名词，而是带你依序完成三件事：
