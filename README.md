...
**AI Agent** 是「由 AI 驅動、能在規則內替人完成事情的系統」。你給它目標，它會看現在發生什麼、選下一步，必要時使用工具，再依結果繼續、修正、停止，或把控制權交還給人。只回答一次的聊天機器人，或每一步都固定寫好的腳本，不一定是 Agent。這個 repo 不要求你一開始就懂所有名詞，而是帶你依序完成三件事：
