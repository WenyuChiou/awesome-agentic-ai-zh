...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="https://github.com/vshulcz/deja-vu">deja-vu</a></td><td>⭐⭐⭐⭐</td><td>先用磁盘上已经存在的记忆</td><td>从 coding agent 的 session 文件做 episodic memory；BM25 检索，不需要 embedding</td><td>MIT；只在本机、只有关键词，没有语义相似度</td></tr>
  </tbody>
  <tbody>
