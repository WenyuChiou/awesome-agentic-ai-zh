...
<details markdown="1">
<summary>⏳ 展开：Model–Harness Fit、Bitter Lesson 与人机分工</summary>

**Model–Harness Fit** 是本章使用的编辑简称，不是公认标准。意思很简单：Harness 常在补某一代模型的弱点；模型变强后，旧补丁可能变成阻力。每加一层，问三件事：
...
<details markdown="1">
<summary>📚 展开：24 笔完整学习资源与限制</summary>
